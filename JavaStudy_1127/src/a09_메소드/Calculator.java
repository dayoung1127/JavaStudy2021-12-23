...
/* 클래스
 class  : 객체에 대하여 정의해 놓은 설계도 or 틀
 object : 클래스를 통해 구현할 수 있는 모든 대상 / 구현한 인스턴스를 대표하는 의미
 instance : 객체가 실제로 구현된 것 / 클래스의 인스턴스라고 표현
 Box(내가정의한 자료형) box = new Box(); <-  생성자
 메소드, 변수명은 대문자 불가
 data / stack / heap(여유공간)
 */
